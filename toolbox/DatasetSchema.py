...
class RelationalTripletDatasetSchema(BaseDatasetSchema):
    ...
    def __init__(self, name: str):
        BaseDatasetSchema.__init__(self, name, "data")
...
class FreebaseFB15k(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(FreebaseFB15k, self).__init__("FB15k")
...
class DeepLearning50a(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(DeepLearning50a, self).__init__("dL50a")
...
class WordNet18(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(WordNet18, self).__init__("WN18")
...
class WordNet18_RR(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(WordNet18_RR, self).__init__("WN18RR")
...
class YAGO3_10(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(YAGO3_10, self).__init__("YAGO3_10")
...
class FreebaseFB15k_237(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(FreebaseFB15k_237, self).__init__("FB15K_237")
...
class Kinship(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(Kinship, self).__init__("Kinship")
...
class Nations(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(Nations, self).__init__("Nations")
...
class NELL_995(RelationalTripletDatasetSchema):
    ...
    def __init__(self):
        super(NELL_995, self).__init__("NELL_995")
...
class DBP15k(RelationalTripletDatasetSchema):
    ...
    def __init__(self, name="fr_en"):
        """
        :param name: choice "fr_en", "ja_en", "zh_en"
        """
        self.dataset_name = name
        super(DBP15k, self).__init__("DBP15k")
...
class DBP100k(RelationalTripletDatasetSchema):
    def __init__(self, name="fr_en"):
        ...
        """
        self.dataset_name = name
        super(DBP100k, self).__init__("DBP100k")
