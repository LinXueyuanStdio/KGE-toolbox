...
class DBP15kData(RelationalTripletData):
    def __init__(self,
        ...
        self.seeds: List[Tuple[str, str]] = []  # (m, 2) 对齐的实体对(a,b)称a为左实体，b为右实体
        self.train_seeds: List[Tuple[str, str]] = []  # (0.8m, 2)
        self.test_seeds: List[Tuple[str, str]] = []  # (0.2m, 2)
        self.seeds_ids: List[Tuple[int, int]] = []  # (m, 2) 对齐的实体对(a,b)称a为左实体，b为右实体
        self.train_seeds_ids: List[Tuple[int, int]] = []  # (0.8m, 2)
        self.test_seeds_ids: List[Tuple[int, int]] = []  # (0.2m, 2)
